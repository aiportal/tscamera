...
{
	class JsonServiceScript
	{
		private object _svc;

		public JsonServiceScript(object svcObject)
		{
			_svc = svcObject;
		}

		public string GenerateScript(string name = null)
		{
			if (string.IsNullOrEmpty(name))
				name = _svc.GetType().Name;

			var members = GenerateFunctions();
